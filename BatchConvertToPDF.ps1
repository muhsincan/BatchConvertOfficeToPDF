...
$wdFormatPDF = 17
 ...
 $word.visible = $false
 $DOCfileTypes = "*.docx","*doc"
 $wordFiles = Get-ChildItem -path $folderpath -include $DOCfileTypes -Recurse
...
$EXCfileTypes = "*.xlsx","*xls"
$excelFiles = Get-ChildItem -Path $folderpath -include $EXCfileTypes -Recurse
